...
export default connect(state => ({
  ...
  render() {
    ...
    // }
    from_coords = { latitude: parseFloat(from_coords.lat || 0), longitude: parseFloat(from_coords.lng || 0) }
    destination_coords = { latitude: parseFloat(destination_coords.lat || 0), longitude: parseFloat(destination_coords.lng || 0) }
    /** FIX ANDROID LOCATION SERVICE CRASH */
