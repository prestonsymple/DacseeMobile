      ...
      <Modal onRequestClose={() => {}} {...this.props} style={{ backgroundColor: 'white' }}>
        {/* <SafeAreaView style={{ flex: 1 }} forceInset={{ top: 'always', horizontal: 'never' }}> */}
          <View style={{ flex: 1, backgroundColor: 'transparent' }}>
            ...
            {/* NavBar */}
            <View style={[
              { height: 88, backgroundColor: 'white' },
              { shadowOffset: { width: 0, height: 1 }, shadowColor: '#666', shadowOpacity: .3, shadowRadius: 3 }
            ]}>
              <View style={{ top: 44, justifyContent: 'space-between', alignItems: 'center', flexDirection: 'row', height: 44 }}>
                ...
                <View style={{ flex: 1, paddingHorizontal: 12 }}>
                  <TextInput {...Define.TextInputArgs} underlineColorAndroid={'white'} onChangeText={keywords => onChangeKeywords(keywords)} placeholder={`Where ${field}?`} style={[
            ...
            {/* List */}
            <View style={[
              { height: Screen.window.height - 120 - 10, marginTop: 15, marginHorizontal: 12, backgroundColor: 'white', borderRadius: 4 },
