      ...
      <View style={{ backgroundColor: '#f8f8f8', flex: 1 }}>
        ...
        <ScrollView style={{ }} contentContainerStyle={{ paddingTop: 15 }}>
          <View style={{ paddingHorizontal: 15, marginBottom: 15, backgroundColor: 'white', height: 64, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <View style={{ flex: 1 }}>
              <Text style={{ fontSize: TextFont.TextSize(14), fontWeight: '400', color: '#666' }}>请先选择银行</Text>
            </View>
            <View style={{ }}>
          ...
          <View style={{ marginBottom: 15, backgroundColor: 'white', paddingHorizontal: 15, height: 64, justifyContent: 'center' }}>
            <Text style={{ fontSize: TextFont.TextSize(14), fontWeight: '400', color: '#666', marginTop: 10 }}>银行账号</Text>
            <TextInput {...Define.TextInputArgs} keyboardType={'number-pad'} style={{ fontSize: TextFont.TextSize(20), height: 38 }} placeholder={'请输入您的银行卡号'} />
          </View>

          <View style={{ marginBottom: 15, backgroundColor: 'white', paddingHorizontal: 15, paddingTop: 10 }}>
            <Text style={{ fontSize: TextFont.TextSize(14), fontWeight: '400', color: '#666' }}>提现金额</Text>
            <View style={{ flexDirection: 'row', height: 44, alignItems: 'center' }}>
              <Text style={{ fontSize: TextFont.TextSize(20), fontWeight: '400', color: '#666' }}>￥</Text>
              <TextInput {...Define.TextInputArgs} style={{ fontSize: TextFont.TextSize(20), height: 44, width: 200 }} placeholder={'0.00'} />
            </View>
            <View style={{ backgroundColor: '#eee', height: 1, top: -2 }} />
            <Text style={{ marginVertical: 7, fontSize: TextFont.TextSize(14), fontWeight: '400', color: '#999' }}>当前最大可提现金额2400.00</Text>
          </View>
        </ScrollView>
        <TouchableOpacity style={{ backgroundColor: '#93eb7a', position: 'absolute', bottom: 0, left: 0, right: 0, height: Define.system.ios.x ? 64 : 44 }}>
          <View style={{ height: 64, justifyContent: 'center', alignItems: 'center' }}>
            <Text style={{ fontSize: TextFont.TextSize(18), color: '#36552d' }}>提交</Text>
          </View>
        </TouchableOpacity>
      </View>
    )
