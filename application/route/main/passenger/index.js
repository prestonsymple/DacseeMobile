  ...
  render() {
    ...
    return (
      <View style={{ flex: 1, width }}>
        ...
        {
          (status === BOOKING_STATUS.PASSGENER_BOOKING_INIT) && (<CircleBar init={true} />)
        }
  ...
  render() {
    ...
    return (
      <Animated.View style={[
        ...
        { shadowOffset: { width: 0, height: 2 }, shadowColor: '#999', shadowOpacity: .5, elevation: 3 },
        { backgroundColor: '#fff', },
        ...
        <View style={{ alignItems: 'center', marginHorizontal: 15, marginVertical: 10, marginBottom: 10 }}>
        ...
        <View style={{ alignItems: 'center', width: width - 30, marginHorizontal: 15, height: Define.system.ios.x ? 66 + 22 : 66, borderRadius: 28, paddingBottom: 10 }}>
          <TouchableOpacity onPress={() => {
            ...
            { shadowOffset: { width: 0, height: 2 }, shadowColor: '#999', shadowOpacity: .5, elevation: 1 },
            { 
              width: width - 30, 
              height: 50, 
              borderRadius: 25, 
