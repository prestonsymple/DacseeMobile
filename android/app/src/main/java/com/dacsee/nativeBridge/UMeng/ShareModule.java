package com.dacsee.nativeBridge.UMeng;
...
public class ShareModule extends ReactContextBaseJavaModule {
    ...
    public static void initSocialSDK(Activity activity){ ma = activity; }
    @Override
    ...
    public void init(String appkey) {
        UMShareAPI.init(contect, appkey);
    }

    @ReactMethod
    public void initSDK() {
        UMShareAPI.get(contect);
    }
