...
import com.dacsee.nativeBridge.PushService.Utils;
...
public class RNPushNotification extends ReactContextBaseJavaModule implements ActivityEventListener {
    public static final String LOG_TAG = "BaiduPush";// all logging should use this tag
    ...
    public void requestPermissions(String senderID) {
        PushManager.startWork(getReactApplicationContext(), PushConstants.LOGIN_TYPE_API_KEY, senderID);
    }
